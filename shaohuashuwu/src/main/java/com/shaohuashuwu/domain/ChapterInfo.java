...
public class ChapterInfo implements Serializable {
    ...
    public ChapterInfo(Integer chapter_pid, String chapter_title, Timestamp chapter_time, Integer chapter_word_num, String chapter_content, String chapter_other_word, Integer chapter_state, Integer chapter_charge) {
    ...
    public ChapterInfo(Integer chapter_pid, String chapter_title, Integer chapter_word_num, String chapter_content, String chapter_other_word, Integer chapter_state, Integer chapter_charge) {
        this.chapter_pid = chapter_pid;
        this.chapter_title = chapter_title;
        this.chapter_word_num = chapter_word_num;
        this.chapter_content = chapter_content;
